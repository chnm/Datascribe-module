...
class Module extends AbstractModule
{
    ...
    public function install(ServiceLocatorInterface $services)
    {
        ...
        $conn->exec('
CREATE TABLE datascribe_user (id INT AUTO_INCREMENT NOT NULL, project_id INT NOT NULL, user_id INT DEFAULT NULL, role VARCHAR(255) NOT NULL, INDEX IDX_D99C3265166D1F9C (project_id), INDEX IDX_D99C3265A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
CREATE TABLE datascribe_value (id INT AUTO_INCREMENT NOT NULL, field_id INT NOT NULL, record_id INT NOT NULL, is_invalid TINYINT(1) DEFAULT NULL, is_missing TINYINT(1) DEFAULT NULL, is_illegible TINYINT(1) DEFAULT NULL, needs_review TINYINT(1) DEFAULT NULL, data LONGTEXT NOT NULL COMMENT \'(DC2Type:json_array)\', INDEX IDX_2FFB3B33443707B0 (field_id), INDEX IDX_2FFB3B334DFD750C (record_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
CREATE TABLE datascribe_record (id INT AUTO_INCREMENT NOT NULL, item_id INT NOT NULL, owner_id INT DEFAULT NULL, approved_by_id INT DEFAULT NULL, created DATETIME NOT NULL, approved DATETIME DEFAULT NULL, INDEX IDX_5628651126F525E (item_id), INDEX IDX_56286517E3C61F9 (owner_id), INDEX IDX_56286512D234F6A (approved_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
CREATE TABLE datascribe_item (id INT AUTO_INCREMENT NOT NULL, dataset_id INT NOT NULL, item_id INT NOT NULL, prioritized_by_id INT DEFAULT NULL, locked_by_id INT DEFAULT NULL, completed_by_id INT DEFAULT NULL, approved_by_id INT DEFAULT NULL, prioritized DATETIME DEFAULT NULL, locked DATETIME DEFAULT NULL, completed DATETIME DEFAULT NULL, synced DATETIME DEFAULT NULL, approved DATETIME DEFAULT NULL, INDEX IDX_4B14C132D47C2D1B (dataset_id), INDEX IDX_4B14C132126F525E (item_id), INDEX IDX_4B14C1324A0B323 (prioritized_by_id), INDEX IDX_4B14C1327A88E00 (locked_by_id), INDEX IDX_4B14C13285ECDE76 (completed_by_id), INDEX IDX_4B14C1322D234F6A (approved_by_id), UNIQUE INDEX UNIQ_4B14C132D47C2D1B126F525E (dataset_id, item_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
CREATE TABLE datascribe_field (id INT AUTO_INCREMENT NOT NULL, dataset_id INT NOT NULL, `label` VARCHAR(255) NOT NULL, hint LONGTEXT DEFAULT NULL, position INT NOT NULL, is_primary TINYINT(1) DEFAULT NULL, data_type VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, data LONGTEXT NOT NULL COMMENT \'(DC2Type:json_array)\', INDEX IDX_6979265FD47C2D1B (dataset_id), UNIQUE INDEX UNIQ_6979265FD47C2D1B462CE4F5 (dataset_id, position), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
CREATE TABLE datascribe_dataset (id INT AUTO_INCREMENT NOT NULL, project_id INT NOT NULL, item_set_id INT DEFAULT NULL, owner_id INT DEFAULT NULL, guidelines LONGTEXT DEFAULT NULL, is_public TINYINT(1) DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, synced DATETIME DEFAULT NULL, created DATETIME NOT NULL, INDEX IDX_2C5AD579166D1F9C (project_id), INDEX IDX_2C5AD579960278D7 (item_set_id), INDEX IDX_2C5AD5797E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
CREATE TABLE datascribe_project (id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, created DATETIME NOT NULL, INDEX IDX_B44944477E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
