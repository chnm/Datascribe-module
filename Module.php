...
class Module extends AbstractModule
{
    ...
    public function install(ServiceLocatorInterface $services)
    {
        ...
        $conn->exec('CREATE TABLE datascribe_value (id INT AUTO_INCREMENT NOT NULL, field_id INT NOT NULL, record_id INT NOT NULL, data LONGTEXT NOT NULL COMMENT \'(DC2Type:json_array)\', missing TINYINT(1) DEFAULT NULL, illegible TINYINT(1) DEFAULT NULL, review TINYINT(1) DEFAULT NULL, INDEX IDX_2FFB3B33443707B0 (field_id), INDEX IDX_2FFB3B334DFD750C (record_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;');
